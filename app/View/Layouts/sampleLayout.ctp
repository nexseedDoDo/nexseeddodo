...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/dodo/app/webroot/css2/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/dodo/app/webroot/css2/agency.css" rel="stylesheet">
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#about">新規登録</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">ようこそ"DoDo"</h2>
                    <h3 class="section-subheading text-muted">これであなたも、Enjoy Cebu!!!!</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>トイレットペーパーってどこが安いの？っていう主婦的情報から、おしゃれスッポトなんかの最新情報まで、出てこいや！！</p>
                            <!-- <p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>セブといえば海、海、海でしょ！！でも海以外もあるんです！！</p>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>セブをなめないで下さい。フィリピン料理だけのはずないでしょ。</p>
    ...
    <!--<script src="/dodo/js/contact_me.js"></script>
